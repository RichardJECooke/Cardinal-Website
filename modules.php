<?php include_once('inc_header.php') ?>
			...
			<section id="main" class="container">
				...
				<div class="box">
					<span class="image featured big"><img src="/images/pic01.jpg" alt="" /></span>
...
<li><a href="https://github.com/AnimatedCircuits/RackModules" target="_blank">Animated Circuits</a></li>
<li><a href="https://github.com/adbrant/ArableInstruments" target="_blank">Arable Instruments</a></li>
<li><a href="https://aria.dog/modules/" target="_blank">Aria Salvatrice</a></li>
<li><a href="https://github.com/AScustomWorks/AS" target="_blank">AS</a></li>
<li><a href="https://vcvrack.com/AudibleInstruments" target="_blank">Audible Instruments</a></li>
<li><a href="https://github.com/NikolaiVChr/Autinn" target="_blank">Autinn</a></li>
<li><a href="https://github.com/kauewerner/Axioma" target="_blank">Axioma</a></li>
...
<li><a href="http://extratone.xyz/modules" target="_blank">Extratone</a></li>
<li><a href="https://github.com/RCameron93/FehlerFabrik" target="_blank">Fehler Fabrik</a></li>
<li><a href="https://github.com/gosub/forsitan-modulare" target="_blank">forsitan modulare</a></li>
<li><a href="https://github.com/VCVRack/Fundamental" target="_blank">Fundamental</a></li>
<li><a href="https://github.com/gluethegiant/gtg-rack" target="_blank">Glue the Giant</a></li>
<li><a href="https://github.com/jensschulze/GoodSheperd" target="_blank">GoodSheperd</a></li>
<li><a href="https://github.com/dbgrande/GrandeModular" target="_blank">Grande</a></li>
<li><a href="https://github.com/hannakoppelaar/h4n4-modules" target="_blank">H4N4 Modules</a></li>
<li><a href="https://gitlab.com/hampton-harmonics/hampton-harmonics-modules" target="_blank">Hampton Harmonics</a></li>
<li><a href="https://github.com/mhetrick/hetrickcv" target="_blank">HetrickCV</a></li>
<li><a href="https://github.com/nysthi/ihtsyn" target="_blank">ihtsyn</a></li>
<li><a href="https://github.com/MarcBoule/ImpromptuModular" target="_blank">Impromptu</a></li>
<li><a href="https://github.com/jeremywen/JW-Modules" target="_blank">JW-Modules</a></li>
<li><a href="https://github.com/janne808/kocmoc-rack-modules" target="_blank">kocmoc</a></li>
<li><a href="https://github.com/TimeControlledOrganism/LifeFormModular" target="_blank">LifeFormModular</a></li>
<li><a href="https://grough.github.io/lilac-loop-vcv" target="_blank">Lilac Loop</a></li>
<li><a href="https://github.com/mgunyho/Little-Utils" target="_blank">Little Utils</a></li>
<li><a href="https://github.com/LomasModules/LomasModules" target="_blank">Lomas Modules</a></li>
<li><a href="https://github.com/VegaDeftwing/LyraeModules" target="_blank">Lyrae Modules</a></li>
<li><a href="https://github.com/knchaffin/Meander" target="_blank">Meander</a></li>
<li><a href="https://github.com/MarcBoule/MindMeldModular" target="_blank">MindMeld</a></li>
<li><a href="https://github.com/martin-lueders/ML_modules" target="_blank">ML Modules</a></li>
<li><a href="https://github.com/MockbaTheBorg/MockbaModular" target="_blank">Mockba Modular</a></li>
...
<li><a href="https://github.com/zezic/ZZC" target="_blank">ZZC</a></li>
					...
					<div class="row">
						<div class="row-6 row-12-mobilep">
							...
							<p>Installing new modules on a Cardinal build is not possible, but we can integrate existing open-source modules to be part of Cardinal.<br/>
							Details on this are available <a href="https://github.com/DISTRHO/Cardinal/discussions/28" target="_blank">here</a>.<br/>
							Also check <a href="https://github.com/DISTRHO/Cardinal/wiki/Possible-modules-to-include" target="_blank">this wiki page</a>
							where we discuss possible modules to include.</p>
						</div>
						<div class="row-6 row-12-mobilep">
							<h3>Module restrictions</h3>
							<p>All included modules are open-source and have a GPLv3+ compatible license. (GPLv3-only modules are not allowed)<br/>
							It is a requirement that the final Cardinal binary is GPLv3+ licensed.</p>
							<p>Module dependencies should be kept at a minimum, as otherwise it quickly grows the complexity of the build.<br/>
							Online access (such as phone-home) is not allowed.</p>
							<p>Worth noting that a few modules have artwork licensed separately from their code.<br/>
							These licenses range from CC-0 to CC-NC-ND to custom (used with permission).<br/>
							An overview of the included artwork licenses can be seen <a href="https://github.com/DISTRHO/Cardinal/blob/main/docs/LICENSES.md#artwork--panel-licenses" target="_blank">here</a>.</p>
							<p>Even though CC-NC is problematic for packaging (some linux distributions are commercial in nature),
							Cardinal allows their use because of how prevalent they are across many Rack modules.<br/>
							Even the Rack "Component Library" (which can be considered the base widget elements) is CC-NC licensed.</p>
